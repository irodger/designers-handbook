...
Далее речь пойдет о редакторе Figma, но если вы работаете в Sketch, то там тоже работает этот принцип
...
Победа компонента очевидна! 🎉 Шутки шутками, а компонент экономит время прежде всего вам самим.  
