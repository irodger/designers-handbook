...
- focus - Фокус-покус - состояние, когда элемент находится во внимании, в фокусе и это не про наведение мышкой. Элемент может оказаться в фокусе, если - на нем произошел клик/тап, например кнопкой tab можно перемещаться к следующему интерактивному элементу на сайте, чтоб понимать какой сейчас элемент выбран, он переходит в состояние focus, которое, в идеале, тоже прорисовывают
