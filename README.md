...
Вечному холивару разработчиков с дизайнерами пришел конец.  
Этот документ представляет собой набор рекомендация для дизайнеров от разработчиков.
...
* [Глава 4. Шрифты (WiP)](#)
* [Глава 5. Состояния (WiP)](#)
* [Глава 6. Компоненты (WiP)](#глава-6-компоненты)
* [Глава 7. Адаптивность макета (WiP)](#)
...
Это можно отнести ко всему, но в нашем случае это относится как к отношениям между `designer <> developer` и `designer <> user`. Когда ты оставляешь на "и так сойдет", этот секс скатывается на плечи тех, кто взаимодействует с твоей работой. Юзеру приходится гадать как тот или иной элемент работает и почему оно сделано так. Разработчику приходится гадать как эти же элементы должны были работать по задумке дизайнера и делать его работу, вместо своей. __Это плохо__.
...
Это очень странный вопрос и если ты задаешься им, у меня плохие новости - ты лабух!  
...
- [ ] Логическая структура разделов макета. Идеально по компонентам, группы с актуальным названием тоже сойдут. Статья от 2014 года для дизайнеров в фотошопе актуальна и по сей день. [Читать](https://cgmag.net/photoshop-etiket-dlya-chajnikov)
